              ...
              <div className="p-6">
                {activeTab === "login" ? (
                  <form className="space-y-4" onSubmit={handleLogin}>
                    ...
                    <button disabled={loading} className={`btn w-full transition-all duration-200 ${loading ? "bg-white/80 backdrop-blur-sm border border-primary/30 shadow-inner" : "bg-primary text-white"}`}>
