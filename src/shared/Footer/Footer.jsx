  ...
  return (
    <div className="bg-black text-white">
      <div className="max-w-7xl mx-auto">
        <footer className="footer p-10 text-md font-semibold lg:py-24 md:py-24">
          <aside className="">
            <h1 className="bg-gradient-to-r from-blue-500 via-purple-500 to-orange-500 bg-clip-text text-transparent text-2xl font-semibold">ZyroMart</h1>
            {/* <svg
              width="50"
              height="50"
              viewBox="0 0 24 24"
